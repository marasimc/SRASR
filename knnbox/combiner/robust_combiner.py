...
class RobustCombiner(nn.Module):
    ...
    def dump(self, path, name_prefix):
        ...
        # step 2. save model
        torch.save(self.state_dict(), os.path.join(path, name_prefix+"robust_combiner.pt"))
    ...
    def load(cls, path):
        ...
        # robust_combiner.load_state_dict(torch.load(os.path.join(path, "checkpointrobust_combiner.pt")))
        robust_combiner.load_state_dict(torch.load(os.path.join(path, "best-r2_zerorobust_combiner.pt")))
