...
from .transformer_adapter import TransformerModelwtAdapter  
from .transformer_encoderf import TransformerModel_f
...
def build_modules(env, params):
    ...
    # modules["encoder_adapter"] = TransformerModelwtAdapter(
    #     params,
    #     env.float_id2word,
    #     is_encoder=True,
    #     with_output=False,
    ...
    #     adapter_fn=True
    # )
    # modules["encoder_f"] = TransformerModel_f(
    #     params,
