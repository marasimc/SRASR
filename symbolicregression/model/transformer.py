...
class TransformerModel(nn.Module):
    ...
    def fwd(
        ...
        # ###### modified
        # tensor_embed = tensor.clone()
        # tensor_decode = tensor.clone()
        # tensor = tensor_decode
        # ###################
    ...
    def generate_with_retrieval(
        ...
        # modified: prev_words
        prev_words = src_len.new(bs).fill_(self.eos_index)
        ...
        while cur_len < max_len:
            ...
            if knn_model:
                ...
                scores = knn_model.get_normalized_probs(net_output, log_probs=True, output_layer=self.output_layer, prev_words=prev_words)
